...
###
Private: prepare an informative header for the compiled file.

options - an Object with the parsing session options

Returns a String of HTML comment.
###
_prepareHeader = (options) ->
    now = (new Date()).toISOString()

    return """<!--
            This file was generated by Active Markdown, v#{ VERSION } - http://activemarkdown.org

            #{options.input_file_name} - #{now}
            -->\n
        """
